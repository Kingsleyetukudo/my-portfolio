...
const Contact = () => {
  return (
    <section className="section" id="contact">
      <div className="container lg:grid lg:grid-cols-2 lg:gap-8 lg:items-stretch">
          ...
          <div className=" flex items-center gap-2 mt-auto">
            {socialLinks.map((socialLink, index) => (
              <a
                ...
                className="w-12 h-12 place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color, color] hover:bg-zinc-50 hover:text-zinc-900 flex items-center justify-center active:bg-zinc-50/80 reveal-up"
                target="_blank"
        ...
        <form
          action="https://getform.io/f/awnqvlgb"
          method="POST"
        ...
        >
          ...
          <button
            type="submit"
            className="btn btn-primary [&]:max-w-full! w-full! justify-center font-bold! reveal-up"
          >
            Send Message
          </button>
        </form>
